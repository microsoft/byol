...
doc_to_text_nya = partial(
    doc_to_text,
    connector={
        "cause": "chifukwa",
        "effect": "kotero",
        "chifukwa": "chifukwa",  # translated "cause" -> Chichewa connector
        "zotsatira zake": "kotero",  # translated "effect" -> Chichewa connector
    },
)

doc_to_text_mri = partial(
    doc_to_text,
    connector={
        "cause": "take",
        "effect": "paanga",
